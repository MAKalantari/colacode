...
addEventListener("mousemove", (e) => {
    ...
    if (isResizing) {
        ...
        resizeNotif.innerText = Math.round(selfBound.width) + "x" + Math.round(selfBound.height) + "px";
        ...
        if (resizing_right) {
            ...
            resizingElement_siblings_on_right.forEach(sibling_data => {
                // sibling_data[0].style.width = sibling_data[1] * sibling_width_multiplier + "px";
